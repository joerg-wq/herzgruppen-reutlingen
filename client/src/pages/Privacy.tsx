        ...
        <section className="py-12 md:py-16">
          <div className="container max-w-3xl">
            <div className="space-y-12">
              {/* Einleitung */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">1. Einleitung</h2>
              ...
              {/* Arten der Daten */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">3. Arten der verarbeiteten Daten</h2>
                <div className="space-y-4 text-muted-foreground">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Anmeldungsdaten</h3>
                    <p>
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Kommunikationsdaten</h3>
                    <p>
              ...
              {/* Rechtsgrundlagen */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">4. Rechtsgrundlagen der Datenverarbeitung</h2>
                <div className="space-y-4 text-muted-foreground">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Einwilligung (Art. 6 Abs. 1 a DSGVO)</h3>
                    <p>
                      Wir verarbeiten Ihre Daten auf Basis Ihrer Einwilligung, die Sie bei der Anmeldung erteilen.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Vertragliche Notwendigkeit (Art. 6 Abs. 1 b DSGVO)</h3>
                    <p>
                      Die Verarbeitung ist notwendig für die Erfüllung unseres Vertrags mit Ihnen zur Teilnahme an den Trainingsgruppen.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Berechtigtes Interesse (Art. 6 Abs. 1 f DSGVO)</h3>
                    <p>
              ...
              {/* Weitergabe */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">6. Weitergabe von Daten</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              {/* Cookies */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">9. Cookies und Tracking</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              {/* Externe Links */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">10. Externe Links</h2>
                <p className="text-muted-foreground">
              ...
              {/* Kontakt */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">11. Datenschutzbeauftragter</h2>
              ...
              {/* Beschwerden */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">12. Beschwerden bei der Aufsichtsbehörde</h2>
                <p className="text-muted-foreground mb-4">
              ...
              {/* Änderungen */}
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4">13. Änderungen dieser Datenschutzerklärung</h2>
                <p className="text-muted-foreground">
